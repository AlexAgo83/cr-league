...
export const CARD_DESCRIPTORS: Record<CardId, CardDescriptor> = {
  ...
  urban_draft: { conditionKey: "card_condition_chosen_rival_mid", strength: "weak", downsideKey: "card_downside_needs_rival" },
  ...
  adjustable_wing: { conditionKey: "card_condition_fast_urban_early", strength: "weak", downsideKey: "card_downside_reliability" },
