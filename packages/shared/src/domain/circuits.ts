...
export const CITY_CIRCUIT_IDENTITIES = [
  ...
  { city: "Marrakech", country: "MA", layoutKey: "circuit_marrakech_heat_ring", laps: 9, trackLengthMeters: 5714, routeLengthMeters: 5714, mainStraightStartProgress: 0.870657, mainStraightEndProgress: 0.895265, startProgress: 0.892312, pitLaneProgress: 0.982775, traits: { grip: 60, overtaking: 68, energy: 52 }, likelyWeather: "dry" },
  ...
  { city: "Lisbon", country: "PT", layoutKey: "circuit_lisbon_tramline", laps: 10, trackLengthMeters: 4951, routeLengthMeters: 4951, mainStraightStartProgress: 0.605056, mainStraightEndProgress: 0.640868, startProgress: 0.636571, pitLaneProgress: 0.974931, traits: { grip: 55, overtaking: 58, energy: 73 }, likelyWeather: "dry" },
  ...
  { city: "Helsinki", country: "FI", layoutKey: "circuit_helsinki_icebreak", laps: 10, trackLengthMeters: 5093, routeLengthMeters: 5093, mainStraightStartProgress: 0.434171, mainStraightEndProgress: 0.457602, startProgress: 0.45479, pitLaneProgress: 0.983598, traits: { grip: 52, overtaking: 61, energy: 72 }, likelyWeather: "light_rain" },
  { city: "Bastia", country: "FR", layoutKey: "circuit_bastia_citadel_loop", laps: 11, trackLengthMeters: 4773, routeLengthMeters: 4773, mainStraightStartProgress: 0.721362, mainStraightEndProgress: 0.74647, startProgress: 0.743457, pitLaneProgress: 0.982425, traits: { grip: 61, overtaking: 69, energy: 66 }, likelyWeather: "dry" }
