...
- Remaining implementation risk is Wave 3 completion: shared/local qualifying, GP resolution, next GP, car unlocks if kept exposed, `Solo local` badge, confirmed solo reset, and broader no-fetch action coverage.
