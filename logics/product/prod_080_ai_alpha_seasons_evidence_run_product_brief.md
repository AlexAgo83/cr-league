...
> Semantic edit: Settled on 2026-07-27 because the linked evidence run is Done and the decision package clears 0.6 beta-season lifecycle as the next corpus.
