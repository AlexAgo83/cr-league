...
# Plan
- [ ] 1. Read AssetImage and its call sites.
- [ ] 2. Add lazy/async defaults with one priority escape hatch if needed.
- [ ] 3. Update only eager-critical call sites.
- [ ] 4. Run typecheck, lint, unit tests, and build.
- [ ] 5. Record which images remain eager and why.
