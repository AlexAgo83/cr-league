...
- request-AC7 -> This backlog slice. Proof: AC2: Tests cover that final replay order equals final classification after one or more staged overtakes.
- request-AC8 -> This backlog slice. Proof: AC3: Tests or screenshots cover representative circuit extremes.
