...
function GameApp({ locale, onLocaleChange }: { locale: Locale; onLocaleChange: (locale: Locale) => void }) {
  ...
  // An arcade game is a place you leave, not a lobby you pass through: the way out belongs in the topbar.
  const inArcadeGame = setupEntryMode === "duel" || setupEntryMode === "wheel";
  const setupTopbar = (
    <SetupTopbar
      hideWordmark
      profileMenu={profileSession ? profileMenu() : null}
