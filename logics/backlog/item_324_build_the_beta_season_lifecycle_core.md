...
- Owner decisions: the first presets are `Quick beta` (3 GP) and `Standard season` (6 GP, default); GP resolution is not automatic; absent players can run visible default plans only through commissioner-controlled resolution.
...
- In:
  ...
  - For absent players, expose the default plan before resolution and record default-plan use in the race report.
...
- AC4: Commissioner-controlled resolve-with-defaults shows absent-player defaults before resolution and marks default-plan teams in the report.
- AC5: Starting the next season or restarting the season preserves players, palmares, archived season stats, and cosmetic/team identity while resetting cards and credits.
- AC6: API and web tests cover season presets, season completion, manual resolution, absent-player defaults, and restart/next-season behavior.
...
- request-AC10 -> This backlog slice. Proof: AC5: Starting the next season or restarting the season preserves players, palmares, archived season stats, and cosmetic/team identity while resetting cards and credits.
- request-AC13 -> This backlog slice. Proof: AC6: API and web tests cover season presets, season completion, manual resolution, absent-player defaults, and restart/next-season behavior.
