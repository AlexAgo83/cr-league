...
export const CITY_CIRCUIT_IDENTITIES = [
  ...
  { city: "Cape Town", country: "ZA", layoutKey: "circuit_cape_town_waterfront_loop", laps: 8, trackLengthMeters: 6120, traits: { grip: 67, overtaking: 74, energy: 58 }, likelyWeather: "dry" },
